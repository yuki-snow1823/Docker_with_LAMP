 ...
 <section>
    ...
    <form method="post" action="reserveCheck.php" >
      <table class="input">
        ...
        <tr>
          <th>連絡先電話番号（※）</th>
          <td><input type="text" name="dtelno" value="<?php echo $dtelno; ?>" /></td></tr>
        <tr>
          <th>メールアドレス</th>
          <td><input type="text" name="dmail" value="<?php echo $dmail; ?>" /></td></tr>
      </table><br />
    <h3>予約詳細情報</h3>
      <table class="input">
        <tr>
          <th>宿泊人数（※）</th>
        <td><input type="text" name="reserveNumber" value="<?php echo $reserveNum; ?>" /></td>
        </tr>
        <tr>
          <th>チェックイン予定時間（※）</th>
        ...
        <tr>
          <th>連絡事項</th><td><textarea name="message" cols="40" rows="4"><?php echo $message; ?></textarea></td>
        </tr>
      </table><br />
