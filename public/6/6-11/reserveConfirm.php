...
<!-- 各ページスクリプト挿入場所 -->
      <section>
        ...
        <h3>代表者情報</h3>
        <table class="input">
          <tr><th>代表者氏名</th><td>（＊＊代表者氏名＊＊）</td></tr>
          <tr><th>連絡先電話番号</th><td>（＊＊電話番号＊＊）</td></tr>
          <tr><th>メールアドレス</th><td>（＊＊メールアドレス＊＊）</td></tr>
        </table>
        <br>
        <h3>予約詳細情報</h3>
        <table class="input">
          <tr><th>宿泊人数</th><td>（＊＊人数＊＊）人</td></tr>
          <tr><th>チェックイン予定時間</th><td>（＊＊チェックイン時間＊＊）</td></tr>
          <tr><th>連絡事項</th><td>（＊＊連絡事項＊＊）</td></tr>
        </table>
        <br>
