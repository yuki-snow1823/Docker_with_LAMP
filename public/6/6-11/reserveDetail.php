 ...
 <section>
    ...
    <form method="post" action="reserveCheck.php" >
      <table class="input">
        <tr>
          <th>代表者氏名（※）</th>
          <td><input type="text" name="dname" value="" /><?php echo $dnameErr; ?></td></tr>
        <tr>
          <th>連絡先電話番号（※）</th>
          <td><input type="text" name="dtelno" value="" /><?php echo $dtelnoErr; ?></td></tr>
        <tr>
          <th>メールアドレス</th>
    ...
    <h3>予約詳細情報</h3>
      <table class="input">
        <tr>
          <th>宿泊人数（※）</th>
        <td><input type="text" name="reserveNumber" value="" /><?php echo $reserveNumErr; ?></td>
        </tr>
        <tr>
          <th>チェックイン予定時間（※）</th>
